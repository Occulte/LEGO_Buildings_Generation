...
from Generation.Utils.unet_3d_blocks import get_down_block, UNetMidBlock3D, get_up_block


@dataclass
class UNet3DOutput(BaseOutput):
    """
    The output of [`UNet3DModel.forward`].
...
class UNet3DModel(ModelMixin, ConfigMixin):
    ...
    Parameters:
        sample_size (`int` or `Tuple[int, int, int]`, *optional*, defaults to `None`):
            Depth, height, width of the input/output sample. Dimensions must be a multiple of '2^(len(block_out_channels)-1)'.
        in_channels (`int`, *optional*, defaults to `1`):
            Number of input channels.
        out_channels (`int`, *optional*, defaults to `1`):
            Number of output channels.
        center_input_sample (`bool`, *optional*, defaults to `False`):
            Weather to center the input sample or not.
        ...
        flip_sin_to_cos (`bool`, *optional*, defaults to `True`):
            Weather to flip sin to cos for Fourier time embedding.
        ...
        mid_block_scale_factor (`float`, *optional*, defaults to `1`):
        ...
        norm_num_groups (`int`, *optional*, defaults to `32`):
            The number of groups for layer normalization.
        ...
        add_attention (`bool`, *optional*, defaults to `True`):
            Weather to add attention to the mid_block layer.
    ...
    def __init__(
            self,
            sample_size: Optional[Union[int, Tuple[int, int, int]]] = None,
            in_channels: int = 1,
            out_channels: int = 1,
            ...
            down_block_types: Tuple[str] = ("DownBlock3D", "DownBlock3D", "AttnDownBlock3D", "AttnDownBlock3D"),
            up_block_types: Tuple[str] = ("AttnUpBlock3D", "AttnUpBlock3D", "UpBlock3D", "UpBlock3D"),
            block_out_channels: Tuple[int] = (192, 384, 576, 768),
    ...
    def forward(
        ...
        Returns:
            [`~models.unet_3d.UNet3DOutput`] or `tuple`:
                If `return_dict` is True, an [`~models.unet_3d.UNet3DOutput`] is returned, otherwise a `tuple` is
