...
from Generation.Utils.resnet import ResnetBlock3D, Downsample3D, Upsample3D
from Generation.Utils.attention_processor import AttnProcessor2_0_3D
...
class DownBlock3D(nn.Module):
    def __init__(
        ...
        for i in range(num_layers):
            in_channels = in_channels if i == 0 else out_channels
            layer_dilation = dilation and (i % 2 == 1)
            resnets.append(
                ResnetBlock3D(
                    in_channels=in_channels,
                    out_channels=out_channels,
...
class UNetMidBlock3D(nn.Module):
    ...
    def __init__(
        ...
        for _ in range(num_layers):
            ...
            layer_dilation = dilation and (_ % 2 == 0)
            resnets.append(
                ResnetBlock3D(
                    in_channels=in_channels,
                    out_channels=in_channels,
